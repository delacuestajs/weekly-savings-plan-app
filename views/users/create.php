...
<div class="max-w-5xl mx-auto bg-white rounded-lg shadow-md p-4 md:p-6">
    ...
    <form action="index.php?module=user&action=store" method="POST" enctype="multipart/form-data" class="max-w-lg">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div class="mb-4">
                <label for="nickname" class="block text-sm font-medium text-gray-700 mb-1"><?= Locale::get('nickname') ?></label>
                <input type="text" id="nickname" name="nickname" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
            </div>
        ...
        <div class="flex flex-wrap gap-3">
            ...
            <a href="index.php?module=user" class="bg-gray-400 hover:bg-gray-500 text-white font-medium py-2 px-4 rounded-lg transition duration-200"><?= Locale::get('cancel') ?></a>
        </div>
    </form>
</div>
